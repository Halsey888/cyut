...
CYUT_BUILDINGS = {
    ...
    "人文與科技大樓 (G)": {
        ...
        "hours": "週一至週五 08:00 – 22:00",
        "phone": "+886 4 2332 3000",
        "google_maps": "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d643.9815174752947!2d120.71402835593032!3d24.069488365368716!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x346925001772d423%3A0x4ef0120e96137d7c!2z5pyd6Zm956eR5oqA5aSn5a245Lq65paH6IiH56eR5oqA5aSn5qiT!5e0!3m2!1szh-TW!2stw!4v1774193695823!5m2!1szh-TW!2stw",
...
def get_ai_core_response(user_text, target_lang_code):
    ...
    """
    final_coords = None
    answer_text = "抱歉，我現在有點問題，請稍後再試。" 
    found_image_base64 = None
    ...
    if target_building_name and target_building_name in CYUT_BUILDINGS:
        ...
        building_prefix = building_info.get("prefix")
                ...
                if os.path.exists(dynamic_image_path):
                    try:
                        ...
                        with open(dynamic_image_path, "rb") as image_file:
                            found_image_base64 = base64.b64encode(image_file.read()).decode('utf-8')
